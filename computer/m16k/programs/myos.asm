...
; first with:  mkmx hello.asm).  asm.mx is deliberately NOT baked in (it
; is ~5 KB): m16k.lua builds it and writes it straight onto the disk.
;
; Layout: kernel 0x0200-0x1FFF (gates at 0x1F00, see SYSCALL_GATES),
;         MEX apps at 0x2000 (a body may spill past 0x3000 -- the kernel
;         is idle while an app runs), free RAM between the kernel image
;         and the gates, stack below 0x4000.
